...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	<form name="form1" action="pay.php" onsubmit="return((allLetter()& allLetter1()& verifyPassword()& check()& address1())==1)">
    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="email" name="ph_no" placeholder="+91">
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                <input type="text" id="zip" name="pincode" placeholder="60001">
              </div>
            </div>
          </div>
